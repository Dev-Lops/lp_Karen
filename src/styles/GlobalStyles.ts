...
@font-face {
  font-family: 'Finesse';
  src: url('/fonts/Finesse/Finesse-Flair.woff2') format('woff2'),
       url('/fonts/Finesse/Finesse-Flair.woff') format('woff'),
       url('/fonts/Finesse/Finesse-Flair.ttf') format('truetype');
  font-weight: normal;
  font-style: normal;
}
...
@font-face {
  ...
  src: url('/fonts/Melodrama/Melodrama-Regular.woff2') format('woff2'),
       url('/fonts/Melodrama/Melodrama-Regular.woff') format('woff'),
       url('/fonts/Melodrama/Melodrama-Regular.ttf') format('truetype');
  font-weight: normal;
  font-style: normal;
}
...
@font-face {
  ...
  src: url('/fonts/Stardom/Stardom-Regular.woff2') format('woff2'),
       url('/fonts/Stardom/Stardom-Regular.woff') format('woff'),
       url('/fonts/Stardom/Stardom-Regular.ttf') format('truetype');
  font-weight: normal;
  font-style: normal;
}
